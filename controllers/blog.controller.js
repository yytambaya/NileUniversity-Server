...
exports.createBlog = (req, res) => {
  const { user, title, content, date, time, location } = req.body;
  var picture;
  if (req.file) {
    picture = req.file.path;
  }
  const newBlog = Blog({ user, title, content, date, time, location, picture });
...
exports.updateBlog = (req, res) => {
  ...
  const updateObj = { user, title, content, date, time, location, picture };
